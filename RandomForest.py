...
This is the Part 1 of assignment ==> Building a Decision Tree and testing it on 
training data. I've separated the Decision Tree classifier and related function,
so that I can even test it independently (As asked in the assignment)
"""
class DecisionTree(object):
    ...
    def buildDecisionTreeModel(self, data, attributesRange=None):
        ...
        This is the Part 3 of assignment ==> In which it is asked to support the
        random feature selection at every level of the decision tree.
        """
...
This is the Part 4 of assignment ==> Implementation an ensemble combination 
scheme based on simple majority voting, which combines multiple trees to make a
single prediction for test data.
"""
class RandomForest(object):
    
    """
    nuOfTrees are the number of DT models to be built. treeModels is to save each
    ...
    This is the Part 2 of assignment ==> Added the option to the classifier to 
    support classification using a random bootstrap sample of examples with 
    replacement.
    """
    ...
    This is also part of point 4 of assignment.
    """
    ...
    def classifyTestData(self, testInstances):
        ...
        Please note: There may be case when indentation of the confusion 
        matrix printed is a bit wrong or not in exact place. the values of 
        True Positive, False Positive, True Negative, False Negative would be 
        perfectly fine
        """
        confusionHeader = "\t"
